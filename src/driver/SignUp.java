...
public class SignUp extends JPanel{
    ...
    SignUp(){
        ...
        //SetBounds for Label
        lbl1.setBounds(10,10,200,60);//FirstName
        lbl2.setBounds(10,60,250,30);//LastName
        lbl3.setBounds(10,100,250,30);//Gender
        lbl4.setBounds(10,140,250,30);//DOB
        lbl5.setBounds(530,140,250,30);//Driving experience
        lbl6.setBounds(10,180,250,60);//Address
        lbl7.setBounds(10,320,250,30);//City
        lbl8.setBounds(10,360,250,30);//Nationality
        lbl9.setBounds(10,400,250,30);//MobileNo
        lbl10.setBounds(10,440,250,30);//Email
        lbl11.setBounds(10,480,250,30);//Password
        lbl12.setBounds(530,480,250,30);//Re-Enter pass
        lbl13.setBounds(530,180,250,60);//Lisence ID
        lbl14.setBounds(10,280,250,30);//car id
        lbl15.setBounds(530,280,250,30);//car company
        lbl16.setBounds(530,320,250,30);//model
        lbl17.setBounds(530,360,250,30);//capacity
        lbl18.setBounds(530,400,250,30);//ac
        lbl19.setBounds(530,440,250,30);//fareperkm

        //SetBounds for textFields
        txtFld1.setBounds(270,10,250,30);//FirstName
        txtFld2.setBounds(270,60,250,30);//LastName
        txtFld3.setBounds(270,140,250,30);//DOB
        txtFld4.setBounds(790,140,250,30);//Driving Experience
        txtFld5.setBounds(270,180,250,60);//Address
        txtFld6.setBounds(270,320,250,30);//City
        txtFld7.setBounds(270,400,250,30);//Mobile No
        txtFld8.setBounds(270,440,250,30);//Email
        txtFld9.setBounds(270,480,250,30);//Password
        txtFld10.setBounds(790,480,250,30);//Re enter pass
        txtFld11.setBounds(270,280,250,30);//Car ID
        txtFld12.setBounds(790,280,250,30);//Company
        txtFld13.setBounds(790,320,250,30);//Model
        txtFld14.setBounds(790,360,250,30);//Capacity
        txtFld16.setBounds(790,440,250,30);//Fare
        txtFld17.setBounds(790,180,250,60);//License ID

        //setBounds for buttons
        btn1.setBounds(270,520,250,30);

        //setBounds for Radio buttons
        radBtn1.setBounds(270,100,250,30);
        radBtn2.setBounds(530,100,250,30);
        radBtn3.setBounds(790,100,250,30);

        //Setbounds for JCombo box
        list1.setBounds(270,360,250,30);
        list2.setBounds(790,400,250,30);
            ...
            public void mouseClicked(MouseEvent e) {
                if(validateEntries()){
                    if(!driverAlreadyPresent()){
                        ...
                        TextField txtFld15=new TextField();
                        Button btn=new Button("Submit OTP");
                        OTPLabel.setBounds(530,520,250,30);
                        txtFld15.setBounds(790,520,250,30);
                        btn.setBounds(790,560,250,30);
                        add(OTPLabel);
                        add(txtFld15);
                        add(btn);
                        ...
                        btn.addMouseListener(new MouseListener() {
                            ...
                            public void mouseClicked(MouseEvent e) {
                                ...
                                else if(TabServer.isValidNumber(txtFld15.getText()) && num==Integer.parseInt(txtFld15.getText())) {
                                    dbInsert();
